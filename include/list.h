 ...
 *
 * Modified from linux-5.18.6 (include/linux/list.h) and criu-3.17.1
...
#define container_of_const(ptr, type, member)                                    \
  _Generic(ptr,                                                                  \
      const __typeof__(*(ptr))*: ((const type*)container_of(ptr, type, member)), \
...
#define list_next_entry_circular(pos, head, member)                                        \
  (list_is_last(&(pos)->member, head) ? list_first_entry(head, __typeof__(*(pos)), member) \
...
#define list_prev_entry_circular(pos, head, member)                                        \
  (list_is_first(&(pos)->member, head) ? list_last_entry(head, __typeof__(*(pos)), member) \
...
#define list_for_each_entry(pos, head, member)                                                         \
  for (pos = list_first_entry(head, __typeof__(*pos), member); !list_entry_is_head(pos, head, member); \
...
#define list_for_each_entry_reverse(pos, head, member)                                                \
  for (pos = list_last_entry(head, __typeof__(*pos), member); !list_entry_is_head(pos, head, member); \
